 ...
 * OrbBackground
 *
 * Renders decorative animated radial-gradient orbs as fixed background elements.
...
export default function OrbBackground({ orbs = DEFAULT_ORBS }: OrbBackgroundProps) {
  return (
    <>
      <style>{`
        @keyframes orb-float {
