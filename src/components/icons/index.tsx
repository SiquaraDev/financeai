...
export function IconSpinner({ size = 15 }: { size?: number }) {
    return (
        <svg
...
export function IconShield({ size = 13 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconDollarSign({ size = 12 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconPieChart({ size = 12 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconActivity({ size = 12 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconBarChart({ size = 12 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconCalendar({ size = 11 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconMonitor({ size = 28 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
...
export function IconCircleAlert({ size = 28 }: { size?: number }) {
    return (
        <svg
            width={size}
            height={size}
